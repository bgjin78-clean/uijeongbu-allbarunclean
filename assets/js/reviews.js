(function () {
  ...
  const REVIEWS = [
    ...
    { area: "의정부3동", service: "유품+특수청소", title: "의정부시 의정부3동 유품정리·특수청소", text: "구도심 다세대 주택에서 유품 분류와 오염 공간 소독을 함께 진행한 사례입니다. 좁은 골목 반출 동선을 사전에 확인했습니다." },
    { area: "금오동", service: "이사폐기물처리", title: "의정부시 금오동 이사폐기물처리", text: "금오동 아파트에서 이사 당일 일정에 맞춰 대형 가구와 생활폐기물을 분류·반출한 사례입니다." },
    { area: "송산동", service: "쓰레기집청소", title: "의정부시 송산동 쓰레기집청소", text: "장기간 방치된 주택 내부 생활폐기물을 구역별로 분류한 뒤 상차·반출까지 마무리한 사례입니다." },
    { area: "낙양동", service: "가정폐기물처리", title: "의정부시 낙양동 가정폐기물처리", text: "외곽 단독주택에서 오래된 가전·가구와 생활폐기물을 하루 일정으로 정리·상차한 사례입니다." },
    { area: "범골동", service: "유품정리", title: "의정부시 범골동 유품정리", text: "범골동 빌라에서 보관할 물품과 정리 대상을 구분해 유품을 분류·반출한 사례입니다." }
  ];
